...
public class PlayerLight : MonoBehaviour
{
    ...
    void lightControl()
    {
        if (Input.GetKeyDown(KeyCode.F))
        {
            ...
            if (active)
            {
                ...
                {
                    StopCoroutine(flickerCoroutine); // Stop any existing flicker coroutine
                }
    ...
    {
        // Wait for 10 seconds before starting to flicker
        ...
        // Ensure the light is turned on after flickering
