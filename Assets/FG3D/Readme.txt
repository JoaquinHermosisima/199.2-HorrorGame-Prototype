Welcome To The Freedom's Gate 3D Creations (FG3D)

Warning! There is a more advanced project: "Deucalion's Humans 2020", look for it on the Asset Store.

******************************************
**** DEUCALION & PYRRHA PROJECT ****
******************************************
...
5 LOD Levels (from 33,656 to 5,489 Tris). The skeletal system is all changed (Genesis-3 DAZ compatible) so it contains 173 bones.
...
Both "Deucalion's Humans" and "Deucalion's Creatures" are DAZ Genesis-3 compatible, so all DAZ Genesis 3 cloth and hair models will be compatible with Deucalion.
...
To complete Deucalion project, you can purchase "Deucalion Add-ons" package; it includes all missing and extra parts and has a special version of Deucalion's Humans that can be used in conjunction with the "Full Body" cloth models. This special version drastically reduces the number of polygons used.

Add-ons Package Content
Humans:
Deucalion_Humans_RDX (Reduced version)
Textures/Maps (Albedo, AO, Normal, Specular):
Caucasoid2 - Caucasoid3 - Congoid2 - Congoid3 - Congoid4 - Mongoloid1 - Vip_AlBeard - Vip_DenzelBeard - Vip_George - Vip_JohnnyBeard - Vip_Robert

Creatures:
Textures/Maps (Albedo, AO, Normal, Specular):
Alien - Fur - Orang - Reptile - Vampire - Zombie

Cloth:
FG3D_Cloth_Deucalion_Wagsuit (Full LOD version)

Animations:
Add more demo animations
...
The "Vendor" folder contains shaders provided by the Unity Blacksmith modified by Morph3d.
